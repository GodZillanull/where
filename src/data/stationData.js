...
export const stations = [
  ...
  { name: "下永谷", kana: "しもながや" },
  { name: "上永谷", kana: "かみながや" },
  { name: "港南中央", kana: "こうなんちゅうおう" },
  { name: "上大岡", kana: "かみおおおか" },
  { name: "弘明寺", kana: "ぐみょうじ" },
  { name: "蒔田", kana: "まいた" },
  { name: "吉野町", kana: "よしのちょう" },
  { name: "阪東橋", kana: "ばんどうばし" },
  { name: "伊勢佐木長者町", kana: "いせざきちょうじゃまち" },
  { name: "関内", kana: "かんない" },
  { name: "桜木町", kana: "さくらぎちょう" },
  { name: "高島町", kana: "たかしまちょう" },
  { name: "横浜", kana: "よこはま" },
  { name: "三ツ沢下町", kana: "みつざわしもちょう" },
  { name: "三ツ沢上町", kana: "みつざわかみちょう" },
  { name: "片倉町", kana: "かたくらちょう" },
  { name: "岸根公園", kana: "きしねこうえん" },
  { name: "新横浜", kana: "しんよこはま" },
  { name: "北新横浜", kana: "きたしんよこはま" },
  { name: "新羽", kana: "にっぱ" },
  { name: "仲町台", kana: "なかまちだい" },
  { name: "センター南", kana: "せんたーみなみ" },
  { name: "センター北", kana: "せんたーきた" },
  { name: "中川", kana: "なかがわ" },
  { name: "あざみ野", kana: "あざみの" },
